...
export function DataGrid<T extends Record<string, any>>({
  ...
  return (
    <div className={cn('w-full', className)}>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            {selectable && selectedRowIds.size > 0 && (
              <Badge variant="primary">{selectedRowIds.size} selected</Badge>
            )}
          </div>
      ...
      {/* Table */}
      <div className={cn('overflow-auto rounded-lg', variantClasses[variant])}>
        <table ref={tableRef} className="w-full table-fixed">
          ...
          >
            <tr>
              {/* Selection column */}
              {selectable && (
                <th className={cn('w-12', sizeClasses[size].headerPadding)}>
                  <Checkbox
                    checked={
                      selectedRowIds.size === processedData.length &&
              ...
              {/* Actions column */}
              {rowActions && (
                <th className={cn('w-20', sizeClasses[size].headerPadding)} />
              )}
            </tr>
          </thead>
            ...
            {loading ? (
              ...
              processedData.map((row, rowIndex) => (
                ...
                >
                  {/* Selection cell */}
                  {selectable && (
                    <td className={cn(sizeClasses[size].padding)}>
                      <Checkbox
                  ...
                  {draggable && onRowReorder && (
                    <td
                      className={cn(sizeClasses[size].padding, 'cursor-move')}
                    >
