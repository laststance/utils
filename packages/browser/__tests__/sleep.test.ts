...
describe('sleep', () => {
  ...
  describe('concurrent usage', () => {
    ...
    it('should work with Promise.all', async () => {
      ...
      await expect(allPromise).resolves.toEqual([undefined, undefined, undefined])
    })
  ...
  describe('edge cases', () => {
    ...
    it('should handle Infinity gracefully', () => {
      expect(() => sleep(Infinity)).not.toThrow()
    })
  })
  ...
  describe('async patterns', () => {
    ...
    it('should work in Promise.resolve context', async () => {
      const promise = Promise.resolve().then(() => sleep(100))
