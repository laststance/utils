  ...
  describe('slugify', () => {
    ...
    describe('unicode and internationalization', () => {
      ...
      it('should handle various European characters', () => {
        ...
        // Cyrillic characters are removed as they're not Latin alphanumeric
        expect(slugify('Москва Санкт-Петербург')).toBe('')
      })
    ...
    describe('real-world examples', () => {
      it('should handle blog post titles', () => {
        expect(slugify('10 Tips for Better JavaScript Code')).toBe(
          '10-tips-for-better-javascript-code',
        )
        expect(slugify('How to Build a REST API with Node.js')).toBe(
          'how-to-build-a-rest-api-with-node-js',
        )
        expect(slugify('Understanding React Hooks: A Complete Guide')).toBe(
      ...
      it('should handle technical terms', () => {
        expect(slugify('JavaScript ES6+ Features')).toBe(
          'javascript-es6-features',
        )
        expect(slugify('CSS-in-JS vs. CSS Modules')).toBe(
          'css-in-js-vs-css-modules',
        )
        expect(slugify('OAuth 2.0 Authentication')).toBe(
          'oauth-2-0-authentication',
        )
      })

      it('should handle user-generated content', () => {
        expect(slugify("What's the best programming language?")).toBe(
          'what-s-the-best-programming-language',
        )
        expect(slugify('My thoughts on Web3 & Crypto...')).toBe(
          'my-thoughts-on-web3-crypto',
        )
        expect(slugify('Why I love TypeScript (and you should too!)')).toBe(
          'why-i-love-typescript-and-you-should-too',
        )
      })
    })
  ...
  describe('escapeHtml', () => {
    describe('basic functionality', () => {
      ...
      it('should handle multiple special characters', () => {
        expect(escapeHtml('<tag attr="value">content</tag>')).toBe(
          '&lt;tag attr=&quot;value&quot;&gt;content&lt;&#x2F;tag&gt;',
        )
        expect(escapeHtml('if (x < 5 && y > 3)')).toBe(
          'if (x &lt; 5 &amp;&amp; y &gt; 3)',
        )
      })
    })
    ...
    describe('security scenarios', () => {
      it('should prevent XSS attacks', () => {
        ...
        xssAttempts.forEach((attempt) => {
          ...
          // Should escape HTML tags, preventing them from being interpreted
      ...
      it('should handle SQL injection-like strings', () => {
        expect(escapeHtml("'; DROP TABLE users; --")).toBe(
          '&#x27;; DROP TABLE users; --',
        )
        expect(escapeHtml("1' OR '1'='1")).toBe(
          '1&#x27; OR &#x27;1&#x27;=&#x27;1',
        )
      })
      ...
      it('should handle various payload formats', () => {
        ...
        expect(
          escapeHtml('<SCRIPT SRC="http://evil.com/xss.js"></SCRIPT>'),
        ).toBe(
    ...
    describe('unicode and special characters', () => {
      ...
      it('should handle mixed unicode and HTML', () => {
        expect(escapeHtml('<div>Héllo Wørld</div>')).toBe(
          '&lt;div&gt;Héllo Wørld&lt;&#x2F;div&gt;',
        )
        expect(escapeHtml('测试 <script>alert("xss")</script> 字符串')).toBe(
          '测试 &lt;script&gt;alert(&quot;xss&quot;)&lt;&#x2F;script&gt; 字符串',
        )
      })
    })
  ...
  describe('unescapeHtml', () => {
    describe('basic functionality', () => {
      ...
      it('should unescape quotes', () => {
        ...
        expect(
          unescapeHtml('&#x27;Single&#x27; and &quot;Double&quot; quotes'),
        ).toBe(`'Single' and "Double" quotes`)
      })
      ...
      it('should unescape additional common entities', () => {
        ...
        expect(unescapeHtml('Registered &reg; Trademark &trade;')).toBe(
    ...
    describe('edge cases', () => {
      ...
      it('should handle partial entities', () => {
        ...
        expect(unescapeHtml('complete &amp; partial &lt')).toBe(
          'complete & partial &lt',
        )
      })
    })
    ...
    describe('round-trip compatibility', () => {
      ...
      it('should handle already-escaped content', () => {
        ...
        expect(unescapeHtml(escapeHtml('&lt;already&gt;'))).toBe(
          '&lt;already&gt;',
        )
      })
    })
