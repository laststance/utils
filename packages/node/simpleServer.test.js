...
describe('simpleServer', () => {
  ...
  it('should create server with correct configuration', async () => {
    ...
    expect(console.log).toHaveBeenCalledWith('Server running at http://127.0.0.1:3000/')
  })
  ...
  it('should start server immediately when module is imported', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Server running at http://127.0.0.1:3000/')
  })
